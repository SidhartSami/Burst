...
Runs 10 interleaved runs in ABABAB order with subprocess isolation.
Measures 64 MB transfer with SHA256 verification, reporting Min, Median, Max, Spread, and Throughput.
"""
...
def main():
    ...
    print("=" * 82)
    print(f"BURST 64 MB INTERLEAVED BENCHMARK: Milestone-2 vs HEAD ({N_RUNS} runs, ABABAB order)")
    print(f"Payload: 64 MB | Server: 127.0.0.1:{port} | 32 x 2 MB uniform chunks")
    print("=" * 82)
